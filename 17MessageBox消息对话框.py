...
class QMessageBoxDemo(QWidget):
    ...
    def showDialog(self):
        ...
        if text == '显示关于对话框':
            # QMessageBox.warning(对象,标题，提示内容，按钮1|按钮2，默认选中按钮)
            ...
            QMessageBox.critical(self,'警告','这是一个错误对话框',QMessageBox.Yes | QMessageBox.No,QMessageBox.No)
        elif text == '显示提问对话框':
            QMessageBox.question(self,'警告','这是一个提问对话框',QMessageBox.No)
